...
const AboutPage = () => {
    return (
        <div className="relative min-h-screen bg-neutral-950 text-white py-16">
            ...
            <BackgroundBeams className="absolute inset-0 -z-10 w-screen h-screen" /> {/* Adjusted width and height */}
        </div>
    );
};
